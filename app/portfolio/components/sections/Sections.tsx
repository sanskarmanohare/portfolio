  ...
  return (
    <section id="home" className="hero section-shell">
      ...
      <motion.div className="hero-portrait" initial={{ opacity: 0, scale: .92, x: 34 }} animate={{ opacity: 1, scale: 1, x: 0 }} transition={{ duration: .85, delay: .12 }}>
        <div className="portrait-backdrop"><Image className="portrait-photo" src="/sanskar-professional.jpeg" alt="Sanskar Manohare in a brown blazer" width={672} height={1536} sizes="(max-width: 700px) 88vw, 520px" priority /><span className="portrait-code">&lt;/&gt;</span></div>
    ...
    <section id="about" className="section-shell content-section">
      ...
      <div className="about-grid">
        <motion.div className="profile-card glass" initial={{ opacity: 0, rotateY: -12 }} whileInView={{ opacity: 1, rotateY: 0 }} viewport={{ once: true }}>
          <div className="profile-visual"><Image className="about-photo" src="/sanskar-about.jpeg" alt="Sanskar Manohare" width={1152} height={2048} sizes="(max-width: 700px) 100vw, 42vw" /><div className="profile-photo-label"><span>BEYOND THE CODE</span><strong>Curious by nature.</strong></div></div>
